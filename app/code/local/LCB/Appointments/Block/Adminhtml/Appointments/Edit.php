 ...
 */
class LCB_Appointments_Block_Adminhtml_Appointments_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    {
        if (Mage::registry("appointments_data") && Mage::registry("appointments_data")->getId()) {
            return Mage::helper("appointments")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("appointments_data")->getId()));
        } else {
